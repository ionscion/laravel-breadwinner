...
<div class="flex flex-col flex-wrap items-center mt-10 mb-10">
    <div class="flex flex-col bg-gray-200 bg-opacity-75 rounded-lg p-4 items-center">
        <h2 class="text-2xl font-bold text-center underline text-gray-800">Classic French Loaf</h2>
        <img class="mt-4 max-w-xs sm:max-w-xl" src="{{ asset('images/final-loaf.jpeg') }}" alt="Final Loaf of Bread">
    ...
    <div class="flex flex-col items-center mt-10 mb-10">
        <div class="bg-gray-200 bg-opacity-75 rounded-lg p-4">
            <h3 class="text-xl font-bold text-center text-gray-800 underline">What You'll Need</h3>
    ...
    <div class="flex flex-col items-center mt-10 mb-10">
        <div class="bg-gray-200 bg-opacity-75 rounded-lg p-4">
            <h3 class="text-xl font-bold text-center text-gray-800 underline">Instructions</h3>
            <ol class="mt-4 list-disc list-inside">
                ...
                <img class="m-4 max-w-xs mx-auto sm:max-w-xl" src="{{ asset('images/dough-proof.jpeg') }}" alt="Dough Glob">
                ...
                <img class="m-4 max-w-xs mx-auto sm:max-w-xl" src="{{ asset('images/proof-basket.jpeg') }}" alt="Dough Rise">
    ...
    <div class="flex flex-col flex-wrap items-center mt-10 mb-10">
        <div class="bg-gray-200 bg-opacity-75 rounded-lg p-4">
            <h4 class="text-xl font-bold text-center text-gray-800 underline">Tips and Tricks</h4>
            <ul class="mt-4 list-disc list-inside">
